...
public class AbstractNewGameControllerTest {
    ...
    public void configure() {
        gameController = new GameController("client", clientHandler, core, configuration, new CircularClientMovementTracker(), loginManager, intercom, npcSystem, itemManager, commandManager, combatSystem, generalInfoManager);
